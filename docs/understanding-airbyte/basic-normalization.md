...
Yes, it is possible to configure the Postgres destination to not truncate table names. You can export and edit the normalization module to have different table names. Unfortunately by default you don’t have option to change the naming system.
